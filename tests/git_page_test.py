...
def test_request_git(client):
    ...
    assert b"You can download Git by it's command-line interface. Github is the website that is used for hosting the projects that use git.</p>" in response.data